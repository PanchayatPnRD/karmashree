      ...
      <div className="flex flex-grow flex-col px-8">
        ...
        <div className="bg-white shadow-md rounded-lg pb-12">
          ...
          <div className="flex justify-center items-center space-x-8">
            ...
            <button
              type="button"
              className="w-1/6 py-2 px-4 border-2 mt-10 rounded-md shadow-sm text-indigo-600 border-indigo-600 bg-white hover:shadow-md transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
              onClick={() => onSubmit("1")}
