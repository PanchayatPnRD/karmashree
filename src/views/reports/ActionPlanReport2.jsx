...
const ActionPlanReport2 = () => {
  ...
  const { data: actionPlan2 } = useQuery({
    queryKey: ["actionPlan2"],
    queryFn: async () => {
  ...
  console.log(actionPlan2, "actionPlan2");
  const ListOptions = [5, 10, 15, "all"];
  const [items, setItems] = useState(ListOptions[0]);

  const data = useMemo(() => actionPlan2 ?? [], [actionPlan2]);
        ...
        <div className=" flex justify-between px-2 items-center h-12">
          ...
          <div className="h-full py-1">
            ...
            <button
              ...
              onClick={() =>
                exportToExcel(rowToArray(), table, "Action_plan_report2")
              }
              // onClick={rowToArray}
            >
              XLSX
            ...
            <button
              ...
              onClick={() => exportToCSV(table, "Action_plan_report2")}
