...
const EmploymentReport = () => {
  ...
  const { data: employmentReport } = useQuery({
    queryKey: ["employmentReport"],
    queryFn: async () => {
  ...
  console.log(employmentReport, "employmentReport");
  const ListOptions = [5, 10, 15, "all"];
  const [items, setItems] = useState(ListOptions[0]);

  const data = useMemo(() => employmentReport ?? [], [employmentReport]);
  ...
  const list = [
    ...
    // },
    {
      header: "Total Implementing Departments",
      accessorKey: "finYear",
      headclass: "cursor-pointer",
    },
    {
        ...
        <div className=" flex justify-between px-2 items-center h-12">
          ...
          <div className="h-full py-1">
            ...
            <button
              ...
              onClick={() =>
                exportToExcel(rowToArray(), table, "Employment_report")
              }
              // onClick={rowToArray}
            >
              XLSX
            ...
            <button
              ...
              onClick={() => exportToCSV(table, "Employment_report")}
