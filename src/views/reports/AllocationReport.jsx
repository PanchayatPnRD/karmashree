...
const AllocationReport = () => {
  ...
  const list = [
    ...
    {
      header: "Total Worker Allocation",
      accessorKey: "sectorName",
      headclass: "cursor-pointer",
    },
    {
      header: "Total Workers Involved",
      accessorKey: "sectorName",
      headclass: "cursor-pointer",
    },
    {
        ...
        <div className=" flex justify-between px-2 items-center h-12">
          ...
          <div className="h-full py-1">
            ...
            <button
              ...
              onClick={() =>
                exportToExcel(rowToArray(), table, "Allocation_report")
              }
              // onClick={rowToArray}
            >
              XLSX
            ...
            <button
              ...
              onClick={() => exportToCSV(table, "Allocation_report")}
