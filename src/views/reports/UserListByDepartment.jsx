...
const UserListByDepartment = () => {
  ...
  const { data: userListByDept } = useQuery({
    queryKey: ["userListByDept"],
    queryFn: async () => {
      const data = await fetch.get(
        `/api/user/userslist-by-department?departmentNo=${karmashree_data?.departmentNo}`
      );
      // console.log(Array.isArray(data.data.result));
      return data.data.result;
    },
  });
  console.log(userListByDept, "userListByDept");
  const ListOptions = [5, 10, 15, "all"];
  const [items, setItems] = useState(ListOptions[0]);

  const data = useMemo(() => userListByDept ?? [], [userListByDept]);
  ...
  const list = [
    ...
    // },
    {
      ...
      accessorKey: "masterdepartment_departmentName",
      headclass: "cursor-pointer",
    },
    {
      header: "Admin User in Rural",
      accessorKey: "Admin User in Rural",
      headclass: "cursor-pointer",
      className: "text-center",
    },
    {
      header: "PIA in Rural",
      accessorKey: "PIA in Rural",
      headclass: "cursor-pointer",
      className: "text-center",
    },
    {
      header: "Operater in Rural",
      accessorKey: "Operater in Rural",
      headclass: "cursor-pointer",
      className: "text-center",
    },
    {
      header: "Admin User in Urban",
      accessorKey: "Admin User in Urban",
      headclass: "cursor-pointer",
      className: "text-center",
      // cell: ({ row }) =>
      //   "-"
    ...
    {
      header: "PIA in Urban",
      accessorKey: "PIA in Urban",
      headclass: "cursor-pointer",
    },
    {
      header: "Operater in Urban",
      accessorKey: "Operater in Urban",
      headclass: "cursor-pointer",
    },
    {
      header: "DNO",
        ...
        <div className=" flex justify-between px-2 items-center h-12">
          ...
          <div className="h-full py-1">
            ...
            <button
              ...
              onClick={() =>
                exportToExcel(
                  rowToArray(),
                  table,
                  "user_list_by_department_report"
                )
              }
              // onClick={rowToArray}
            >
            ...
            <button
              ...
              onClick={() =>
                exportToCSV(table, "user_list_by_department_report")
              }
...
export default UserListByDepartment;
