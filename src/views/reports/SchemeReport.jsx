...
const SchemeReport = () => {
  ...
  const { data: schemeReport } = useQuery({
    queryKey: ["schemeReport"],
    queryFn: async () => {
  ...
  console.log(schemeReport, "schemeReport");
  const ListOptions = [5, 10, 15, "all"];
  const [items, setItems] = useState(ListOptions[0]);

  const data = useMemo(() => schemeReport ?? [], [schemeReport]);
  ...
  const list = [
    ...
    {
      header: "Total Schemes with Work Order Issued",
      accessorKey: "sectorName",
      headclass: "cursor-pointer",
    },
    {
      header: "Total Project Cost for Work Order issued",
      accessorKey: "FundingDeptname",
      headclass: "cursor-pointer",
    },
    {
      header: "Total Unskilled workers for Work Order issued",
      accessorKey: "FundingDeptname",
      headclass: "cursor-pointer",
    },
    {
        ...
        <div className=" flex justify-between px-2 items-center h-12">
          ...
          <div className="h-full py-1">
            ...
            <button
              ...
              onClick={() =>
                exportToExcel(rowToArray(), table, "Scheme_report")
              }
              // onClick={rowToArray}
            >
              XLSX
            ...
            <button
              ...
              onClick={() => exportToCSV(table, "Scheme_report")}
