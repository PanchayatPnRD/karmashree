...
const ActionPlanReport1 = () => {
    ...
    const { data: employmentList } = useQuery({
        ...
        queryFn: async () => {
            const data = await fetch.get(
                `/api/actionplan/Action_Plan_Report-1`
            );
    ...
    const list = [
        ...
        {
            header: "Total District Working",
            accessorKey: "TOTAL_DISTRICT_WORKING",
            headclass: "cursor-pointer",
            className: "text-center",
        ...
        },
        {
            ...
            className: "text-center",
            cell: ({ row }) =>
                row.original.No_of_works_proposed == "" ? "-" : row.original.No_of_works_proposed,
        },
        {
            ...
            className: "text-center",
            cell: ({ row }) =>
                row.original.Tentative_Total_Cost_of_works == "" ? "-" : row.original.Tentative_Total_Cost_of_works,
        },
        {
            ...
            headclass: "cursor-pointer",
            cell: ({ row }) =>
                row.original.Tentative_Total_Wage_to_be_paid_in_the_works == "" ? "-" : row.original.Tentative_Total_Wage_to_be_paid_in_the_works,
        },
        {
...
export default ActionPlanReport1