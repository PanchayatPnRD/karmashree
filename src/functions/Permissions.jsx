...
export const Calc_permission = ( category, role_type, dno_status ) => {
  const permissionList = [
    ...
    { category: "DIST", roleType: 1, dnoStatus: true, uniqueId: 12 },
    { category: "DIST", roleType: 1, dnoStatus: false, uniqueId: 13 },
    { category: "DIST", roleType: 3, dnoStatus: true, uniqueId: 14 },
    { category: "DIST", roleType: 3, dnoStatus: false, uniqueId: 15 },
    { category: "DIST", roleType: 2, dnoStatus: true, uniqueId: 16 },
    ...
    { category: "BLOCK", roleType: 1, dnoStatus: true, uniqueId: 24 },
    { category: "BLOCK", roleType: 1, dnoStatus: false, uniqueId: 25 },
    { category: "BLOCK", roleType: 3, dnoStatus: true, uniqueId: 26 },
    { category: "BLOCK", roleType: 3, dnoStatus: false, uniqueId: 27 },
    { category: "BLOCK", roleType: 2, dnoStatus: true, uniqueId: 28 },
  ...
  return permissionList.find(
    (p) => p.category === category && p.roleType === role_type && p.dnoStatus === dno_status
  );
};
