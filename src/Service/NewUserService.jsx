...
export const getAllDistrictList = async (data) => {
  return await webApi.get(
    `/api/mastertable/getAllDistricts/${data ? data : 0}`
  );
};
...
export const getAllSubDivisionList = async (districtId, subDivision) => {
  return await webApi.get(
    `/api/mastertable/getSubdivison/${parseInt(districtId)}/${
      parseInt(subDivision) ? parseInt(subDivision) : 0
    }`
  );
};
...
export const getAllBlockList = async (districtId, blockCode) => {
  return await webApi.get(
    `/api/mastertable/getBlock/${parseInt(districtId)}/${
      parseInt(blockCode) ? parseInt(blockCode) : 0
    }`
  );
};
...
export const getAllBlockListbySub = async (districtId, subdivId) => {
  return await webApi.get(
    `/api/mastertable/getBlockbydistandsub/${parseInt(districtId)}/${parseInt(
      subdivId
    )}`
  );
};
